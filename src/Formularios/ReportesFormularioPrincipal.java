 ...
 * @author Josue Lacayo
 */
public class ReportesFormularioPrincipal extends javax.swing.JPanel {

    /**
     * Creates new form clases
     */
    public ReportesFormularioPrincipal() {
        initComponents();
    ...
    public static void Move (JPanel p){
        panelModificable.setPreferredSize(new java.awt.Dimension(1467, 790));
    ...
    private void initComponents() {
        ...
        panelModificable.setPreferredSize(new java.awt.Dimension(1470, 790));
        ...
        lblLBitacora.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Reportes/reportes barra.png"))); // NOI18N
        ...
        btnCerrar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Reportes/Botón cerrar.png"))); // NOI18N
        ...
        add(btnCerrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(1840, 20, -1, -1));

        sombracerrar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Reportes/Sombra cerrar.png"))); // NOI18N
        add(sombracerrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(1810, -10, -1, -1));

        lblTitulo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Reportes/Reportes titulo.png"))); // NOI18N
